...
export function timelineToFcpxml(
  ...
  // FCP 12.0 (macOS 26.2) crashes during audio preflight on any connected clip
  // regardless of element type (<audio>, <asset-clip>, or <spine lane>).
  // Suppress all connected clips until Apple documents a working multi-track format.
